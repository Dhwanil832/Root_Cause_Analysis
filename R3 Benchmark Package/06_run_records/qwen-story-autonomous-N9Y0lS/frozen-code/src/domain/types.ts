...
export type AgentId = TagId | 'incident-understanding' | 'incident-structuring' |
  ...
  'evidence-adjudication' | 'causal-analysis' | 'causal-verification' | 'corrective-actions' | 'revision';
...
export interface EvidenceSourceAssessment {
  ...
  applicability: 'direct-r3' | 'similar-equipment' | 'general-guidance' | 'unknown';
