...
async function mutationWithRecovery(endpoint,body,isComplete){
...
try{
  ...
  await save('manifest.json',{model,targetVersions:target,title,description,startedAt:state.startedAt,
    ...
    rules:{sameModelOnly:true,humanAnswers:false,automaticRelease:true,strictCausalCommit:true,
      maxFullCyclesPerRequest:2,maxRequestsPerAction:2,deadlineHours:24,
      stopOnEvidenceExhaustion:true,stopOnUncertainMutation:true,promptVersion:'try4.1.0-story-autonomous'}});
