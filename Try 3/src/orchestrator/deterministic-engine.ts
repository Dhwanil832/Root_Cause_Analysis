...
export function runDeterministicAnalysis(
  ...
  const edges = conditionFacts.map((condition) => ({
    ...
    status: 'proposed' as const, sourceIds: ['incident-description'], verified: false,
  }));
  ...
  return {
    ...
    questions, skippedQuestions: brokered.skipped, answers, documentIntelligence, evidenceClaims, conflicts: [],
