...
Try 4 is a local-first, evidence-led root-cause investigation workbench. It keeps each run owned by one model, adjudicates source quality before specialist reasoning, persists stage checkpoints, filters weak questions, enforces forward evidence-cited causal links, and gates corrective actions behind verified causes.
