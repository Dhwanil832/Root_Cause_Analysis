...
import { FeaturedComparisonCard } from './featured-comparison-card';
  ...
  return (
    <main className="library-shell">
      ...
      <section className="library-content">
        ...
        {loading && <div className="empty-state">Loading other preserved runs…</div>}
        {error && <div className="empty-state error-state">{error}</div>}
        {!loading && !error && items.length === 0 && (
          <div className="empty-state">
            <h2>No additional investigations yet</h2>
            <p>The pinned board comparison is available below. New investigations will appear after their model tracks are created.</p>
