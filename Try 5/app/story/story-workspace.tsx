...
export function StoryWorkspace({trackId}:{trackId:string}) {
  ...
  return <main className="story-workspace">
    <header><p className="story-eyebrow">TRY 5 · EXTERNAL BENCHMARK SIMULATOR</p><h1>One model. Two separate roles.</h1><p>The story role holds a fixed scenario. The RCA role receives only the answers you release—not the hidden scenario or its private memory.</p>
