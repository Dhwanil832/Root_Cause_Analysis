      ...
      const result = await runAgentStage({
        ...
        packet: {
          ...
          document: {
            ...
            extractedTextPreview: document.extractedText.slice(0, 12_000),
            totalExtractedCharacters: document.extractedText.length,
            textCoverage: 'Preview only for media interpretation. Full extracted text is separately retained, chunked and searched by the evidence stages.',
          },
        },
      });
