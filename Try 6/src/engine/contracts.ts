...
export const schemas = { ...investigationSchemas, read: readSchema, understand: understandSchema, tag: tagSchema, specialist: readSchema,
...
export function taskSchema(kind: keyof typeof schemas, sources: string[], findings: string[], questions: string[], targetStatement = '', sourceLines?:Record<string,number[]>, nodeRefs?: string[]): z.ZodType {
  if (isInvestigationKind(kind)) return investigationSchema(kind, findings, sources, questions, nodeRefs);
