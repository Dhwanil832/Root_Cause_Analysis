...
export const ENGINE_VERSION = 'try6.1.0';
export type TaskKind = 'read' | 'understand' | 'tag' | 'specialist' | 'broker' | 'answer' | 'interpret' | 'review' | 'causal' | 'inquiry' | 'verify' | 'actions' | 'frame' | 'consult' | 'resolve' | 'refine' | 'connect';
