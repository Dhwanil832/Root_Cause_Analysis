...
const base = process.env.RCA_APP_URL || `http://127.0.0.1:${process.env.RCA_PORT || 3016}`;
...
console.log(`Try 6 investigation worker polling ${base}; one model task at a time.`);
let lastError = '';
